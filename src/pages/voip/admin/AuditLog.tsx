...
import { ScrollText, ChevronLeft, ChevronRight, Trash2, Loader2 } from "lucide-react";
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will permanently delete all {pagination.total} audit log entries. This action cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            ...
            <AlertDialogAction onClick={handleClearAll} disabled={isClearing} className="bg-destructive text-destructive-foreground">
              {isClearing ? <><Loader2 className="w-4 h-4 mr-2 animate-spin" /> Clearing...</> : "Clear All"}
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
